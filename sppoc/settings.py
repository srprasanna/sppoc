"""
Django settings for sppoc project.
...
SECRET_KEY = '!48wrsf%*1a*(58(0b_=vo$qk^_e=xbn04m)-6enm93g2s-v^a'
...
ROOT_URLCONF = 'sppoc.urls'

WSGI_APPLICATION = 'sppoc.wsgi.application'
